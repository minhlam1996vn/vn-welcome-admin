    ...
    public function toArray(Request $request): array
    {
        return $this->collection->map(function ($item) {
            return [
                ...
                "article_thumbnail" => $item->article_thumbnail ? Storage::url($item->article_thumbnail) : 'https://source.unsplash.com/random/1280x720?cryptocurrency&' . $item->id, //'https://placehold.jp/1280x720.png'
                "category" => [
                    "id" => $item->category->id,
