...
@push('styles')
    <style>
        /*
                        ...
                        * Generated on Wed, 07 Feb 2024 14:32:36 GMT.
        ...
        /* CKEDITOR CUSTOM CSS */
        .ck-content .ck.ck-reset_all {
            display: none;
        }

        .ck-content .ck.ck-icon {
            display: none;
        }
    </style>
@endpush
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Hiển thị trên PC</h5>
                </div>
                <div class="card-body">
                    <h1 class="h3 fw-bold">Tết với nhiều Hy vọng</h1>
                    <span>Thứ hai, 19/2/2024 | <span>12:03</span> GMT+7</span>
                    <hr>
